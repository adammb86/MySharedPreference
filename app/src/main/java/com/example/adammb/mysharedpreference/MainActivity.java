...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    TextView tvName, tvAge, tvPhoneNo, tvEmail, tvIsLoveHarryPotter;
    Button btnSave;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvIsLoveHarryPotter = (TextView) findViewById(R.id.tv_is_harry_potter);
    ...
    private void showExistingPreference() {
        if (!TextUtils.isEmpty(mUserPreference.getName())) {
            ...
            tvIsLoveHarryPotter.setText(mUserPreference.isHarryPotter() ? "Ya" : "Tidak");
            ...
            tvIsLoveHarryPotter.setText(TEXT_EMPTY);
