...
public class FormUserPreferenceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rgLoveHarryPotter = (RadioGroup) findViewById(R.id.rg_love_harry_potter);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_save) {
            ...
            boolean isLoveHarryPotter = rgLoveHarryPotter.getCheckedRadioButtonId() == R.id.rb_yes;
            ...
            if(!isEmpty){
                ...
                mUserPreference.setLoveHarryPotter(isLoveHarryPotter);
            }
    ...
    private void showPreferenceInForm(){
        ...
        if(mUserPreference.isHarryPotter()){
